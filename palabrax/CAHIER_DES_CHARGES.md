# PALABRAX - Plateforme de Gestion de Chatbots
...
**PALABRAX** est une plateforme SaaS permettant de déployer, gérer et monitorer des chatbots IA sur plusieurs sites web depuis une interface centralisée unique.
...
| Rôle | Besoins |
|------|---------|
| **Admin PALABRAX** | Gérer tous les workspaces, voir les stats globales |
...
```html
<script src="https://palabrax.example.com/widget.js" 
...
- [ ] Logo personnalisé
- [ ] Suppression "Powered by PALABRAX"
...
```
widget/
├── palabrax-widget.js     # Script principal (~50KB)
├── palabrax-widget.css    # Styles inline
